...
const site = {
  ...
  "repo": "claims",
  "stage": "Beta",
  "description": "Deterministic documentation-claim coverage checks for tests and AI-assisted release loops.",
  "lead": "Keep README and docs promises anchored to source text and mapped to real tests.",
  "quickstart": "pnpm add -D @async/claims\npnpm run pipeline:verify",
  "docsRoots": [
    "docs"
  ]
};
